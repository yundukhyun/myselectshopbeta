...
public class NaverApiService {
    ...
    public List<ItemDto> searchItems(String query) {
        ...
        headers.add("X-Naver-Client-Id", "WJYEy6DjQ7PTPunNqHte");
        headers.add("X-Naver-Client-Secret", "7SopayIeeN");
        String body = "";
        ...
        return fromJSONtoItems(response);//api에서 가져온 리스트값을 fromJSONtoItems메서드의 매개 변수에 넣어줌
    }

    public List<ItemDto> fromJSONtoItems(String response) { //여기서 Dto로 반환 해줌
